...
2. \\\`Main\\\` lacks the \\\`string[] args\\\` parameter or returns an invalid type.
...
I evaluated your request using **\${channel.name}** model \\\`\${channel.defaultModel || 'default'}\\\`.

Here is the C# code solution for your workspace:
